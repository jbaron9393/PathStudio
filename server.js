...
// Grossing Manual is hosted as a separate static site. Keep this local route
// for existing bookmarks and redirect users to the current manual URL.
app.get(["/grossing-manual", "/grossing-manual/*"], (_req, res) => {
  return res.redirect(302, GROSSING_MANUAL_URL);
});
